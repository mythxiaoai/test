        ...
        try { var info = gen[key](arg); 
          ...
          return; 
            ...
            step("next", value); },
             ...
             //模拟ajax\n
             function ajax(str, time) {  return new Promise(function (reslove, reject) {
                   setTimeout(function () {      reslove(str + "返回结果成功");  
                   }, time || 1000);  });}_asyncToGenerator( 
                     /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
                         var a, b, c;  return regeneratorRuntime.wrap(
                           function _callee$(_context) {    while (1) {
                                  switch (_context.prev = _context.next) {        case 0:
                                    _context.next = 2;          return ajax("a");
                                            case 2:\n          a = _context.sent;\n          _context.next = 5;\n          return ajax(\"b\");\n\n        case 5:\n          b = _context.sent;\n          _context.next = 8;\n          return ajax(\"c\");\n\n        case 8:\n          c = _context.sent;\n\n          console.log(a, b, c);\n\n        case 10:\n        case \"end\":\n          return _context.stop();\n      }\n    }\n  }, _callee, this);\n}))();\n\n//实践\nvar list = {\n  init: function () {\n    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {\n      var p, n;\n      return regeneratorRuntime.wrap(function _callee2$(_context2) {\n        while (1) {\n          switch (_context2.prev = _context2.next) {\n            case 0:\n              _context2.next = 2;\n              return this.pre();\n\n            case 2:\n              p = _context2.sent;\n\n              console.log(p);\n              _context2.next = 6;\n              return this.next();\n\n            case 6:\n              n = _context2.sent;\n\n              console.log(n);\n\n            case 8:\n            case \"end\":\n              return _context2.stop();\n          }\n        }\n      }, _callee2, this);\n    }));\n\n    function init() {\n      return _ref2.apply(this, arguments);\n    }\n\n    return init;\n  }(),\n  pre: function pre() {\n    return ajax(\"pre\", 2000);\n  },\n  next: function next() {\n    return ajax(\"next\");\n  }\n};\n// list.init();\n\n//# sourceURL=webpack:///./async-await.js?"
...
/***/ 0:
/*!*********************************************!*\
  !*** multi babel-polyfill ./async-await.js ***!
  \*********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

eval("__webpack_require__(/*! babel-polyfill */\"./node_modules/babel-polyfill/lib/index.js\");\nmodule.exports = __webpack_require__(/*! C:\\Users\\Myth\\Documents\\HBuilderProject\\Demo\\page\\5.ajax异步加载怎么避免地狱回调\\babel/async-await.js */\"./async-await.js\");\n\n\n//# sourceURL=webpack:///multi_babel-polyfill_./async-await.js?");
