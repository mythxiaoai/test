...
drag.init({
	dom:dom,	//dom元素
	dir:"x/y",	//方向 x  y
	proxyChild:1,	//代理子类的下标  从0开始
	ghost:"true",	//是否开启镜像  true  false
	callbackDur:function(){},	//mousemove过程中的回调函数   this={left:left,top:top,rateLeft:与父元素的比,rateTop,与父元素的比}
	callbackEnd:function(){}	//mouseup停止拖拽后的回调函数 this={left:left,top:top,rateLeft:rateLeft,rateTop,rateTop}
	})
*/
(function(win){
			...
			init:function(json){
				...
				json.dom.onmousedown=function(e){
					...
					document.onmousemove=function(e){
						...
						result.rateLeft=l/mainDom.offsetParent.offsetWidth;
						result.rateTop=t/mainDom.offsetParent.offsetTop;
						result.left=l;
						result.top=t;
						result.dom=mainDom;
