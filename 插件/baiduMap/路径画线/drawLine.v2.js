...
class drawLine {
    ...
    main() {
        ...
        for (let i = 0, len = this.points.length; i < len; i++) {
            ...
            //画线
            this.searchBetweenLine(pre, val, this.arr[i]);
     ...
     * @param {Object} e终点
     */
    searchBetweenLine(s, e, val) {
        //拿到经纬度  画线
        let paths = [];
        for (let json of val.steps) {
            let temp = json.path.split(";");
            temp.forEach(function(json2) {
                let temp2 = json2.split(",");
                paths.push(new BMap.Point(temp2[0], temp2[1]));
            });
        }
        ...
        var polyline = new BMap.Polyline(paths, {
            ...
            //icons:[icons],
            strokeOpacity: .9, //折线的透明度，取值范围0 - 1
