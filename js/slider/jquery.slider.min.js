(function(t, i, s, e) {
	...
	l.prototype = {
		...
		render: function() {
			var t = '<div class="ui-slider-wrap">' + '<div class="ui-slider-text ui-slider-no-select ui-slider-animate">' + this.opts.textMsg + "</div>" + '<div class="ui-slider-btn init ui-slider-no-select"></div>' + '<div class="ui-slider-bg"></div>' + "</div>";
			this.ele.html(t);
			this.initStatus()
		},
		initStatus: function() {
