...
/**
    ...
    add(opts,callback){
      ...
      var $this =this,
      //添加a和iframe
      htmlDom=$("<a href='javascript:;' class='nav_item action' data-text='"+opts.name+"' data-src='"+opts.src+"' data-id='"+opts.id+"'>"+opts.name+"<i class='fa fa-close nav_close' title='关闭'></i></a>");
      $this.navs.append(htmlDom);
      $this.iframes.append($("<iframe name='iframe"+opts.id+"' frameborder='0' seamless width='100%' height='100%' src="+opts.src+"></iframe>"));
